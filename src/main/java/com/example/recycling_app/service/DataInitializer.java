            ...
            */
            ...
            for (String[] row : allRows) {
                ...
                WasteGuide wasteGuide = new WasteGuide(
                        ...
                        row[3], // 생활쓰레기배출방법 (generalWasteMethod)
                        row[4], // 음식물쓰레기배출방법 (foodWasteMethod)
                        row[5], // 재활용가능쓰레기배출방법 (recyclableWasteMethod)
                        row[6], // 대형생활폐기물배출방법 (bulkyWasteMethod)
                        row[7], // 캔류배출방법 (canMethod)
                        row[8], // 고철류배출방법 (metalMethod)
                        row[9], // 유리병류배출방법 (glassBottleMethod)
                        row[10], // 종이류배출방법 (paperMethod)
                        row[11], // 플라스틱류배출방법 (plasticMethod)
                        row[12]  // 비닐류배출방법 (vinylMethod)
                );
